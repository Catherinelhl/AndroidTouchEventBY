...
class SeleViewGroup(context: Context?, attrs: AttributeSet?) : LinearLayout(context, attrs) {
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        println("SeleViewGroup onTouchEvent...${StringTools.getActionNameBy(
            event!!.action
        )}")
    ...
    override fun dispatchTouchEvent(event: MotionEvent?): Boolean {
        println("SeleViewGroup dispatchTouchEvent ...${StringTools.getActionNameBy(
            event!!.action
        )}")
    ...
    override fun onInterceptTouchEvent(event: MotionEvent?): Boolean {
        println("SeleViewGroup onInterceptTouchEvent ...${StringTools.getActionNameBy(
            event!!.action
        )}")
